...
async def get_symptoms(prompt: str, sex: str, age: int) -> dict:
    ...
    possible_illnesses = requests.post(
    ...
    possible_illnesses = json.loads(possible_illnesses.text)["conditions"]
    ...
    return {"illnesses": possible_illnesses, "symptoms": possible_symptoms}
